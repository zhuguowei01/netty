...
public class DnsResponseDecoder extends MessageToMessageDecoder<DatagramPacket> {
     ...
     */
    protected static DnsResponse decodeResponse(ByteBuf buf, InetSocketAddress sender) {
        DnsResponse response = new DnsResponse(sender);
    ...
    protected void decode(ChannelHandlerContext ctx, DatagramPacket packet, List<Object> out) throws Exception {
        out.add(decodeResponse(packet.content().retain(), packet.sender()));
    }
